    ...
    >
      <div className="grid grid-cols-3 gap-3">
        <label className="col-span-2 flex flex-col gap-1">
          <span className="text-xs uppercase tracking-widest font-medium text-subtle">成果物名</span>
          <input
            type="text"
            name="name"
            required
        ...
        <label className="flex flex-col gap-1">
          <span className="text-xs uppercase tracking-widest font-medium text-subtle">バージョン</span>
          <input
            type="number"
            name="version"
            min={1}
      ...
      <label className="flex flex-col gap-1">
        <span className="text-xs uppercase tracking-widest font-medium text-subtle">ファイルURL（任意）</span>
        <input
          type="url"
          name="file_url"
