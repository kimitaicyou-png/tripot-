  ...
  return (
    <main className="min-h-screen bg-surface">
      <header className="bg-card border-b border-border px-6 py-4">
        <h1 className="text-lg font-semibold text-ink">MoneyForward クラウド連携</h1>
      </header>
        ...
        <section className="bg-card border border-border rounded-xl p-5 shadow-sm">
          ...
          <div className="space-y-2">
            <button
              type="button"
              disabled
              className="w-full px-4 py-2 bg-slate-100 text-muted text-sm rounded-lg cursor-not-allowed"
            >
