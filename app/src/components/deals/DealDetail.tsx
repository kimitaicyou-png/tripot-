            ...
            <div className="bg-white rounded-2xl shadow-sm p-5 mb-5">
              ...
              {deal.stage === 'claim_resolved' && (
                <div className="border-t border-gray-100 pt-3 mt-4">
                  <button onClick={() => handleStageChange('invoiced')} className="w-full py-2.5 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 active:scale-[0.98] transition-all duration-200">請求済にする</button>
